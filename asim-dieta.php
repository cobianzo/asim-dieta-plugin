<?php
/**
 * Plugin Name: Asim Dieta
 * Plugin URI: https://github.com/cobianzo/asim-dieta-plugin
 * Description: A Asim Dieta for WordPress complete with inline documentation and working admin options page.
 * Author: Arun Basil Lal
 * Author URI: https://www.asimsrl.com/
 * Version: 1.0
 * Text Domain: asim
 ...
 * license.txt					- GPL v2
 * asim-dieta.php				- Main plugin file containing plugin name and other version info for WordPress.
 ...
 *
 * - Plugin name: Asim Dieta (S&R)
 * - Plugin folder slug: asim-dieta (S&R)
 ...
 * - Update readme.txt
 * - Update PREFIX_VERSION_NUM 			in asim-plugin.php (keep this line for future updates)
 */
...
if ( ! defined( 'PREFIX_ASIM_PLUGIN' ) )		define( 'PREFIX_ASIM_PLUGIN'		, trim( dirname( plugin_basename( __FILE__ ) ), '/' ) ); // Name of the plugin folder eg - 'asim-dieta'
if ( ! defined( 'PREFIX_ASIM_PLUGIN_DIR' ) )	define( 'PREFIX_ASIM_PLUGIN_DIR'	, plugin_dir_path( __FILE__ ) ); // Plugin directory absolute path with the trailing slash. Useful for using with includes eg - /var/www/html/wp-content/plugins/asim-dieta/
if ( ! defined( 'PREFIX_ASIM_PLUGIN_URL' ) )	define( 'PREFIX_ASIM_PLUGIN_URL'	, plugin_dir_url( __FILE__ ) ); // URL to the plugin folder with the trailing slash. Useful for referencing src eg - http://localhost/wp/wp-content/plugins/asim-dieta/
...
// Load everything
require_once( PREFIX_ASIM_PLUGIN_DIR . 'loader.php' );
